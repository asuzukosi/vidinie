...
import { VideoPipelineDeleteButton } from "./video-pipeline-delete-button";
    ...
    return (
      <TableRow key={videoPipeline.id} className="hover:bg-muted/50" onClick={() => handleVideoPipelineClick(videoPipeline)}>
        ...
        <TableCell className="h-16 px-2 text-sm text-muted-foreground">
          {videoPipeline.instructions.length > 20 ? videoPipeline.instructions.substring(0, 20) + "..." : videoPipeline.instructions}
        </TableCell>
      ...
      <Table className="min-w-[370px] w-full">
        <TableHeader>
          <TableRow className="hover:bg-transparent border-b">
            ...
            <TableHead className="h-12 px-2 font-medium w-[10%]">Instructions</TableHead>
